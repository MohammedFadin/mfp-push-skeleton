require.config({
  paths: {
    ibmmfpfanalytics:
      "../node_modules/ibm-mfp-web-sdk/lib/analytics/ibmmfpfanalytics",
    ibmmfpf: "../node_modules/ibm-mfp-web-sdk/ibmmfpf",
    // MFPPush: "../node_modules/ibm-mfp-web-push/MFPPush",
  },
});
require(["ibmmfpfanalytics", "ibmmfpf", "MFPPush"], function (
  analytics,
  WL,
  // MFPPush
) {
      ...
      WLAuthorizationManager.obtainAccessToken().then(
        function (accessToken) {
          ...
          var resourceRequest = new WLResourceRequest(
            "/adapters/userProfile/unprotected",
